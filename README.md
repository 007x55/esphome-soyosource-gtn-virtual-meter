...
| [esp32-homeassistant-example.yaml](esp32-homeassistant-example.yaml)                     | Monitor[^1] the inverter and control the power output on demand using an ESP32 and an MQTT power sensor                            |
